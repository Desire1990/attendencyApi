...
SECRET_KEY = 'django-insecure-=3%ep=^1vziexljf=r3a-89-f+vc==dbzcaqys60p@cwg6e*#s'
...
ROOT_URLCONF = 'attendency_api.urls'
...
WSGI_APPLICATION = 'attendency_api.wsgi.application'
